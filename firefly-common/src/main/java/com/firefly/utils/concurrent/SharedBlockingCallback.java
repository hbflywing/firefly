...
/**
 * Provides a reusable {@link Callback} that can block the thread while waiting
 * to be completed.
 * <p>
...
public class SharedBlockingCallback {
	private static Throwable IDLE = new Throwable() {
		...
		private static final long serialVersionUID = 2839201304149405751L;
	...
	private static Throwable SUCCEEDED = new Throwable() {
		...
		private static final long serialVersionUID = 3201333456423359501L;
	...
	private static Throwable FAILED = new Throwable() {
		...
		private static final long serialVersionUID = 7378407146943258362L;
