...
public class HTTPServerDemo4 {
	...
	public static void main(String[] args) {
		...
		HTTP2Server server = new HTTP2Server("localhost", 7777, http2Configuration, new ServerHTTPHandler.Adapter()
				.messageComplete(new Func4<Request, Response, HTTPOutputStream, HTTPConnection, Boolean>() {

					@Override
					public Boolean call(Request request, Response response, HTTPOutputStream outputStream,
